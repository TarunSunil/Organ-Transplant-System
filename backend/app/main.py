...
from app.routes import donors, recipients, match, logs, transport, Dashboard  # ✅ import dashboard
...
app.include_router(Dashboard.router, prefix="/dashboard", tags=["Dashboard"])  # ✅ dashboard endpoints
